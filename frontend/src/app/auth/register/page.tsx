      ...
      <div className="relative h-[40vh] w-full flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <p className="text-primary uppercase tracking-widest text-xs mb-3 font-semibold drop-shadow-md">Membership</p>
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl text-white drop-shadow-lg mb-4">Request Access</h1>
            <p className="text-white/70 font-light max-w-md mx-auto">Join our exclusive dining platform.</p>
          </motion.div>
        </div>
      </div>
